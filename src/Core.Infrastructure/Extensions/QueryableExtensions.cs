...
namespace Core.Infrastructure.Extensions
{
    public static class QueryableExtensions
    {
        ...
        /// <param name="map">A function for mapping entities to response objects.</param>
        /// <param name="searchPredicateBuilder">An optional function to build search expressions based on a search string.</param>
        ...
        public static async Task<PageResponse<TResponse>> GetPageDataAsync<TEntity, TResponse>(
            ...
            Func<string, Expression<Func<TEntity, bool>>>? searchPredicateBuilder = null,
            ...
            where TResponse : class
        {
            ...
            if (searchPredicateBuilder is not null && !string.IsNullOrWhiteSpace(oData.Search?.RawValue))
            {
                var searchExpression = searchPredicateBuilder(oData.Search.RawValue);
            ...
            var response = entities.Select(map).ToList();
